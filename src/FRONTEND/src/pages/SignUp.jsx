    ...
    <main className="min-h-screen pt-24 pb-12 flex flex-col items-center justify-center relative overflow-hidden bioluminescent-glow">
      ...
      <div className="glass-panel ghost-border rounded-2xl p-8 md:p-10 w-full max-w-md flex flex-col items-center relative z-10 shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8 w-full text-center">
          <Link
            to="/"
            className="text-4xl font-bold tracking-tight text-secondary font-headline mb-2 hover:scale-105 transition-transform"
          >
            OLA
          </Link>
          ...
          <p className="text-on-surface-variant text-sm mt-2">
            Create account to conveniently check your LoL performance
          </p>
        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-on-surface-variant ml-1 font-headline">
              Email or Riot ID
            </label>
            <div className="relative flex items-center">
              <span className="material-symbols-outlined absolute left-4 text-on-surface-variant/50">
                person
              </span>
              <input
                type="text"
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center px-1">
                <label className="text-sm font-bold text-on-surface-variant font-headline">
                  Password
                </label>
              </div>
              <div className="relative flex items-center">
        ...
        <button className="w-full bg-[#eb0029] hover:bg-[#c90022] h-14 text-white font-bold py-3 rounded-lg flex items-center justify-center gap-3 transition-colors active:scale-95 cursor-pointer">
          <img src={RiotLogo} />
          <span>Sign up with Riot Account</span>
        </button>
        ...
        <p className="text-sm text-on-surface-variant mt-8 text-center">
          ...
          <Link
            to="/login"
            className="text-secondary font-bold hover:underline hover:text-secondary-dim pl-1"
          >
            Log in
          </Link>
        </p>
